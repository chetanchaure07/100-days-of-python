...
v = int(input("Enter any number(+ve or -ve): "))
if ( v > 0):
    if ( v % 2) == 0 :
        print(f"{v} is positive even number")
    else: 
        print(f"{v} is positive odd number")
elif v == 0:
    print("0 is neither positive nor negative, but it is even")
else:
    if ( v % 2) == 0 :
        print(f"{v} is negative even number")
    else: 
        print(f"{v} is negative odd number")